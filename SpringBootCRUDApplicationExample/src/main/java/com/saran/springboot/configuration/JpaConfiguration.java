package com.saran.springboot.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.saran.springboot.repositories",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.saran.springboot.model" });
